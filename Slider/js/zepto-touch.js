...
!function ($) {
    $.fn.slider = function (fn,option) {
        new Slider({
            ...
            barHeight: (option && option.barHeight) || 50
        });
    }
    ...
    function Slider(option) {
        ...
        this.slipping(this, option.barHeight);
        this.barHeight = option.barHeight;//
        this.ps = $(".ps");
    }

    Slider.prototype.creatProcessBar = function (parentHeight,sliderBarHeight) {//生成滚动条
        ...
        style = "<style>.ps{position:absolute;right:4%;height:" + parentHeight + "px;width:2px;background:#f90;top:0;opacity:0;-webkit-transition:400ms opacity;}\
                 .cs{position:absolute;top:0;height:" +sliderBarHeight + "px;width:2px;background:green;}\
                </style>";
        $("head").append(style);
        this.slider.parent().css({ position: "relative"}).append("<div class='ps'><div class='cs'></div></div>");
    };

    Slider.prototype.slipping = function (_this, sliderBarHeight) {
        var self = _this;
       ...
       self.isEnableDefaultMove && $(document).on("touchmove", function (e) {
        ...
        this.creatProcessBar(parentHeight, sliderBarHeight);//生成滚动条
        self.slider.on("touchstart", function (e) {
            ...
            self.slider.on("touchmove", function (e) {
                ...
                self.slider.parent().find(".cs").css("-webkit-transform", "translate3d(0," + (parentHeight - self.barHeight) * scale + "px,0)");
